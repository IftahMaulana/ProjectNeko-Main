                    ...
                    <div class="select" tabindex="0" role="button">
                        <div class="text-links">
                            <div class="d-flex gap-2 align-items-center">
                                <img src="{{ asset('assets/images/' . Auth::user()->foto) }}" class="rounded-circle" style="width: 50px;" alt="">
                ...
                <li class="nav-item">
                    <div class="notif">
                        <a href="/checkOut" class="fs-5 nav-link {{ Request::path() == 'checkOut' ? 'active' : '' }}">
                            <i class="fa fa-cash-register"></i> <span style="font-size: 0.8em;">Payment</span>
                        </a>
                    </div>
                </li>
            </ul>
